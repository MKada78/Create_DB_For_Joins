...
TESTING CROSS JOIN
-- _________________________________________________________________
INSERT INTO products_test(product_name, price)
VALUES('iPhone', 699),
      ('iPad',599),
      ('Macbook Pro',1299);

INSERT INTO stores_test(store_name)
VALUES('North'),
      ('South');

INSERT INTO sales_test(store_id,product_id,quantity,sales_date)
...
CONSTRAINTS
-- ____________________________________________________________________________________________________________________________________________
-- Adding FK to table customers:
ALTER TABLE customers 
    ADD CONSTRAINT `customers_ibfk_1` 
        FOREIGN KEY (`salesRepEmployeeNumber`) 
           REFERENCES `employees` (`employeeNumber`);

-- Adding 1st FK to table employees:
ALTER TABLE employees
    ADD CONSTRAINT `employees_ibfk_1` 
	    FOREIGN KEY (`reportsTo`) 
	        REFERENCES `employees` (`employeeNumber`);

-- Adding 2nd FK to table employees:
ALTER TABLE employees
...
-- Adding 1st FK to table orderdetails:
ALTER TABLE orderdetails
    ADD CONSTRAINT `orderdetails_ibfk_1` 
	    FOREIGN KEY (`orderNumber`)
	        REFERENCES `orders` (`orderNumber`);

-- Adding 2nd FK to table orderdetails:
ALTER TABLE orderdetails
    ADD CONSTRAINT `orderdetails_ibfk_2` 
	    FOREIGN KEY (`productCode`)
	        REFERENCES `products` (`productCode`);

-- Adding FK to table products:
...
-- Adding 1st FK to sales_test:
ALTER TABLE sales_test
    ADD CONSTRAINT `sales_prod` 
	    FOREIGN KEY (product_id)
	        REFERENCES products_test (id);

-- Adding 2nd FK to sales_test:
ALTER TABLE sales_test
    ADD CONSTRAINT `sales_stores` 
	    FOREIGN KEY (store_id)
	        REFERENCES stores_test (id);
